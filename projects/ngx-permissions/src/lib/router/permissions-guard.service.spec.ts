...
describe('Permissions guard only', () => {
    ...
    it ('sholud return true when only fullfills', fakeAsync(() => {
      ...
      (permissionGuard.canActivate(route, {} as RouterStateSnapshot) as any).then((data) => {
    ...
    it ('should return true when neither only not except specified', fakeAsync(() => {
        ...
        expect(permissionGuard.canActivate(route, {} as RouterStateSnapshot) as any).toBe(true);
    }));
